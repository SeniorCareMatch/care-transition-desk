...
export function CoordinatorPrototype() {
      ...
      <div className="flex">
        ...
        <main className="min-w-0 flex-1 px-4 pb-28 pt-6 sm:px-6 lg:px-8 lg:pb-12 lg:pt-8">
          <div className="mx-auto max-w-[1440px]">
            ...
            {view === "facilities" && <Facilities homes={visibleHomes} medicaidOnly={medicaidOnly} vacanciesOnly={vacanciesOnly} setMedicaidOnly={setMedicaidOnly} setVacanciesOnly={setVacanciesOnly} onPlace={openPlacement} />}
          </div>
        </main>
      </div>
...
function Facilities({ homes: visible, medicaidOnly, vacanciesOnly, setMedicaidOnly, setVacanciesOnly, onPlace }: { homes: typeof homes; medicaidOnly: boolean; vacanciesOnly: boolean; setMedicaidOnly: (value: boolean) => void; setVacanciesOnly: (value: boolean) => void; onPlace: () => void }) {
  return (
    <>
